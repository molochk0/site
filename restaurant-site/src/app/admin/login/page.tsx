          ...
          <div className=\"bg-white rounded-lg shadow-lg p-8 space-y-6\">
            ...
            <div className=\"space-y-4\">
              ...
              <motion.button
                ...
                className=\"w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors\"
              >
